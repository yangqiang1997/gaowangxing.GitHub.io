<template>
  <div>
    <el-form :model="formData" ref="formData" :rules="rules"  label-width="80px" class="left">
      ...
      <el-button type="primary" @click="sure('formData')" class="button1" :loading="loading">确定</el-button>
    ...
    methods: {
      sure: function (fromName) {
        this.$refs[fromName].validate((valid) => {
          if (valid) {
            this.loading = true;
            RoleManagementApi.AddARole(this.formData).then(res => {
              this.loading = false;
